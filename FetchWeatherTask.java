...
//        Log.d("FetchWeatherTask", "dsini yg bikin sort order nyatu");
        //cek apakah sudah ada, kl sudah ada, maka dapatkan idnya
        //kl belum ada, input data
        if(locationCursor.moveToFirst()){
            int locationIdIndex = locationCursor.getColumnIndex(WeatherContract.LocationEntry._ID);
            idNya = locationCursor.getLong(locationIdIndex);
        }else {
            ...
            idNya = ContentUris.parseId(insertedUri);
        }
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                // set day of year + 1, kemudian ambil milisecondnya
